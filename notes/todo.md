...
Измененёный параграфd

Совершенно новый параграф
...
-  при открытии каталога через ctrl+лкм бесконечно загружается каталогв
...
-  Починить открытие текущей статьи в публикации  изменений (при условии, что в публикации изменений есть текущая статья)
   ...
   ![](./todo.png "title (123)2"){width=252px height=80px}
...
-  Исправить баг в github [https://github.com/Gram-ax/gramax/issues/2112312323](https://github.com/Gram-ax/gramax/issues/2)
